...
이클립스 톰캣 내장
실제 배포 경로 : 실제 서비스 되고 있는 소느는 아래 폴더 소스
D:\thezone\web\WebBack\WebLabs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP
...
<body>
	<%	
		...
		//실 배포 경로
		//D:\thezone\web\WebBack\WebLabs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP\WebJSP
		
		String filepath = application.getRealPath(resourcepath); //
		out.print("file real path 실제 경로 "  + filepath  +"<br>");
		//실 배포 경로
		//D:\thezone\web\WebBack\WebLabs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP\download\note.txt
	
		//개발 소스 경로
		//D:\thezone\web\WebBack\WebLabs\WebJSP\src\main\webapp\download\note.txt
	%>
	...
	System.out.println("SP : " + sp);
	/* 
	URL : http://192.168.0.160:8090/WebJSP/Ex09_WebApp_RealPath.jsp
